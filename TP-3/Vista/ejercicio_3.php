  ...
  <div class="modal modal-signin position-static d-block bg-secondary py-5">
    <div class="modal-content rounded-1 shadow">
      <div class="modal-header border-bottom-0">
        ...
        <h5 class="modal-title">Cinem@as</h5>
      </div>

      <div class="modal-body py-0">
        <form class="row g-3 needs-validation" method="post" action="ejercicio_3_respuesta.php" enctype="multipart/form-data" novalidate>
          <div class="col">
            <div class="col-md-10">
